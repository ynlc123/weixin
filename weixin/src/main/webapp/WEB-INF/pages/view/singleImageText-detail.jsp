...
<div data-role="page" id="header">
    ...
    <div data-role="content">
    	<h4 style="text-align: center;">${imageText.title }</h4>
    	<h6 style="text-align: center;"><fmt:formatDate value="${imageText.createTime}" pattern="yyyy-MM-dd" /></h6>
        <img style="width:100%;" src="http://114.215.110.9/${imageText.image.path }">
