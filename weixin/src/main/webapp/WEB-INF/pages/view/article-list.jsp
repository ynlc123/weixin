...
<div data-role="page">
    ...
    <div data-role="content">
        <ul data-role="listview" data-inset="true">
		    ...
		    <li><a href="/view/article/detail.htm?uuid=${article.uuid }">${article.title }</a></li>
		    </c:forEach>
		</ul>
        <div data-role="footer" data-position="fixed">
            <div data-role="navbar">
                <ul>
                    ...
                    <li><a class="ui-btn-active" href="/view/article/list.htm?originalId=${platform.originalId }" data-icon="grid">文章列表</a></li>
