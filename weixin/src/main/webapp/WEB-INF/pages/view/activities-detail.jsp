...
<div data-role="page" id="header">
    ...
    <div data-role="content">
    	<h4 style="text-align: center;">${activities.title }</h4>
    	<h6 style="text-align: center;"><fmt:formatDate value="${activities.createTime}" pattern="yyyy-MM-dd" /></h6>
        <img style="width:100%;" src="http://192.168.1.3:8080/${activities.image.path }">
