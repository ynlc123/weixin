...
<body>
	...
	<div class="container" style="min-height: 370px;">
        <div class="alert alert-danger" role="alert" style="margin-top: 100px;margin-bottom: auto;width: 500px;height: 200px;margin-left: auto;margin-right: auto;">注册失败！</div>
    </div>
	<!--footer-->
