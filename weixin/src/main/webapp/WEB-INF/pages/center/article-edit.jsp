...
<body>
	...
	<div class="container content">
	    <form action="/center/article/update.htm" method="post" class="form-horizontal" role="form" style="width: 800px;max-width:100%;margin-left: auto;margin-right: auto">
	        ...
	        <div class="form-group">
	        	<input type="hidden" name="attachId" value="${article.image.id }">
