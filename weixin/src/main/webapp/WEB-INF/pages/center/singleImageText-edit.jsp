...
<body>
	...
	<div class="container content">
	    <form action="/center/singleImageText/update.htm" method="post" class="form-horizontal" role="form" style="width: 800px;max-width:100%;height: 600px;margin-left: auto;margin-right: auto">
	        <input type="hidden" name="uuid" value="${imageText.uuid }">
	        <legend><h6 style="font-weight: bold">编辑单图文回复</h6></legend>
	        <div class="form-group">
	            <label for="keywords" class="col-sm-2 control-label">关键词</label>
	            <div class="col-sm-10">
	                <input type="text" class="form-control input-sm" id="keywords" name="keywords" placeholder="输入关键词" maxlength="10" value="${imageText.keywords }">
	        ...
	        <div class="form-group">
	            ...
	            <div class="col-sm-10">
	                <input type="text" class="form-control input-sm" id="title" name="title" placeholder="输入标题" maxlength="20" value="${imageText.title }">
	                <span class="help-block"></span>
	            </div>
	        </div>
	        <div class="form-group">
	            ...
	            <div class="col-sm-10">
	                <script type="text/plain" id="myEditor" name="content" style="width:650px;height:240px;">${imageText.content }</script>
	            </div>
	            <span class="help-block" id="content_tips"></span>
	        </div>
	        <div class="form-group">
	        	<input type="hidden" name="attachId" value="${imageText.image.id }">
	            ...
	            <div id="upload-list">
					    ...
					    <div class="cancel"><a href="javascript:;" class="del-upload-file" data-id="${imageText.image.id }">X</a></div>
					    <span class="fileName">${imageText.image.title }</span><span class="data"></span>
					    </div>
				    </div>
	        </div>
