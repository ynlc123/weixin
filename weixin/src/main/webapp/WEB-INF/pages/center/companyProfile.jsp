...
<body>
	...
	<div class="container content">
	    <form action="/center/companyProfile/update.htm" method="post" class="form-horizontal" role="form" style="width: 800px;max-width:100%;height: 600px;margin-left: auto;margin-right: auto">
	        <legend><h6 style="font-weight: bold">编辑公司简介</h6></legend>
	        <div class="form-group">
	            <label for="companyName" class="col-sm-2 control-label">公司名称</label>
	            <div class="col-sm-10">
	                <input type="text" class="form-control input-sm" id="companyName" name="companyName" placeholder="输入公司名称" value="${profile.companyName }">
	            </div>
	        </div>
	        <div class="form-group">
