...
<body>
	...
	<div class="container content">
	    <form class="form-horizontal" role="form" style="width: 800px;max-width:100%;height: 600px;margin-left: auto;margin-right: auto">
	        <legend><h6 style="font-weight: bold">设置默认文本回复</h6></legend>
	        <div class="form-group">
	            <label for="myEditor" class="col-sm-2 control-label">回复内容</label>
	            <div class="col-sm-10">
	            	<textarea rows="8" style="width: 100%;" name="content" id="content" maxlength="500">${message.content}</textarea>
	...
	<script src="/js/defReplyMsg.js"></script>
</body>
</html>