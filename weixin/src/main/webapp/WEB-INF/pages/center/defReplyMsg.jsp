...
<body>
	...
	<div class="container content">
	    <form action="/center/defReplyMsg/update.htm" method="post" class="form-horizontal" role="form" style="width: 800px;max-width:100%;height: 600px;margin-left: auto;margin-right: auto">
	        <legend><h6 style="font-weight: bold">默认自动回复消息</h6></legend>
	        <div class="form-group">
	            <label for="myEditor" class="col-sm-2 control-label">回复内容</label>
	            <div class="col-sm-10">
