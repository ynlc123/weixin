...
<body>
	...
	<div class="container content">
	    <form action="/center/autoReplyText/save.htm" method="post" class="form-horizontal" role="form" style="width: 800px;max-width:100%;height: 600px;margin-left: auto;margin-right: auto">
	        <legend><h6 style="font-weight: bold">添加文本回复</h6></legend>
