...
(function () {
    ...
    var tmp = window.location.pathname;
        URL = "/ueditor/1.2.3.0/";//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:"/center/upload/image/uploadEditorPic.htm"             //图片上传提交地址
        ...
        //图片在线管理配置区
        ,imageManagerUrl:"/center/upload/image/manageEditorPic.htm"       //图片在线管理的处理地址
        ,imageManagerPath:""           //图片修正地址，同imagePath

        //屏幕截图配置区
        ,snapscreenHost: '1'                                  //屏幕截图的server端文件所在的网站地址或者ip，请不要加http://
        ...
        ,toolbars:[["FullScreen","Undo","Redo","Preview","|","FontFamily","FontSize","Bold","Italic","Underline","ForeColor","StrikeThrough","Superscript","Subscript","PastePlain","Spechars","|","JustifyLeft","JustifyCenter","JustifyRight","JustifyJustify","InsertUnorderedList","InsertOrderedList","|","InsertImage","ImageNone","ImageLeft","ImageRight","ImageCenter","SnapScreen","InsertVideo","|","InsertTable","DeleteTable","|","GMap","Map","|","SearchReplace","SelectAll"]]
        //当鼠标放在工具栏上时显示的tooltip提示
        ,labelMap:{'fullscreen':'','undo':'','redo':'','preview':'','|':'','fontsize':'','bold':'','italic':'','underline':'','forecolor':'','strikethrough':'','superscript':'','subscript':'','pasteplain':'','spechars':'','|':'','justifyleft':'','justifycenter':'','justifyright':'','justifyjustify':'','insertunorderedlist':'','insertorderedlist':'','|':'','insertimage':'','imagenone':'','imageleft':'','imageright':'','imagecenter':'','snapscreen':'','insertvideo':'','|':'','inserttable':'','deletetable':'','|':'','searchreplace':'','selectall':''}
      ...
      ,fullscreen : false //是否开启初始化时即全屏，默认关闭
       ...
       ,pasteplain:false  //是否纯文本粘贴。false为不使用纯文本粘贴，true为使用纯文本粘贴
        ...
        , serialize : {
              //黑名单，编辑器会过滤掉一下标签
              blackList:{a:1,applet:1,script:1,input:1, meta:1, base:1, button:1, select:1, textarea:1,'map':1, 'area':1}
        }
