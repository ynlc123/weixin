            ...
            if (e[0]) {
                if (e[0] == "*") {
                    ...
                    if (len == 1 && typeof (c("#" + e[len - 1]).find('input[name="attachId"]').val()) != "undefined") {
                        ...
                        console.log("/image/delete.htm");
                        $.ajax({url: "/image/delete.htm", dataType: "json", type: "post", data: {uuid: c("#" + e[len - 1]).find('input[name="attachId"]').val()}, success: function (data, textStatus) {
            ...
            switch (g) {
                case SWFUpload.QUEUE_ERROR.QUEUE_LIMIT_EXCEEDED:
                    if (e.queueSizeLimit > f) {
                        this.queueData.errorMsg += '\n选定的文件数超过上传限制,最多能选择 (' + (parseInt(f)+1) + ') 个文件';
                    } else {
