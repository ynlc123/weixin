        ...
        this.each(function () {
            ...
            if (e[0]) {
                if (e[0] == "*") {
                    ...
                    var len= e.length;
                    var cThis = c(this);
                    if (len == 1 && typeof (c("#" + e[len - 1]).find('input[name="attachId"]').val()) != "undefined") {
                        i.cancelUpload(e[len - 1]);
                        console.log("/attachment!delete.htm");
                        $.ajax({url: "", dataType: "json", type: "post", data: {id: c("#" + e[len - 1]).find('input[name="attachId"]').val()}, success: function (data, textStatus) {
...
//
                                    ...
                                    if(queue.find(".init-edit:visible").size()==0){
                                        _a.hide();
                                    }
                                    uploadInit(fileId,queueId,pId);
                                });
