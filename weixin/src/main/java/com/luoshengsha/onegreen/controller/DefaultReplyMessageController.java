 ...
 */
@Controller
public class DefaultReplyMessageController {
	/** 记录日志**/
    static Logger logger = Logger.getLogger(DefaultReplyMessageController.class);
    
    @Resource
    private DefaultReplyMessageService messageService;
    @Resource
    ...
    public ModelAndView defaultReplyMessage() {
    	try {
			...
			DefaultReplyMessage message = messageService.getByPlatform(platform);
